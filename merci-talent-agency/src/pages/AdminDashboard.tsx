...
import { Plus, Edit, Trash2, LogOut, LayoutDashboard, Users, Newspaper, Settings, Save, Check, Briefcase } from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  return (
    <div className="pt-20 pb-32 container-custom">
      <Modal
          ...
          <div className="space-y-12">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  <label className="text-[10px] tracking-widest text-brand-gray uppercase block mb-2">Email</label>
                  <input 
                    type="email"
                    className="input-field"
