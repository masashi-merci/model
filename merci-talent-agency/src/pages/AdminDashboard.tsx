              ...
              <div className="grid grid-cols-1 gap-8">
                <div>
                  ...
                  <textarea 
                    ...
                    onChange={(e) => setSettings(prev => prev ? { ...prev, service_model_casting_text: e.target.value } : { id: 'default', hero_image: '', about_image: '', service_model_casting_text: e.target.value, updated_at: '' })}
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    onChange={(e) => setSettings(prev => prev ? { ...prev, service_event_staffing_text: e.target.value } : { id: 'default', hero_image: '', about_image: '', service_event_staffing_text: e.target.value, updated_at: '' })}
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    onChange={(e) => setSettings(prev => prev ? { ...prev, service_production_text: e.target.value } : { id: 'default', hero_image: '', about_image: '', service_production_text: e.target.value, updated_at: '' })}
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                  ...
                  <ImageUpload 
                    onUpload={(url) => setSettings(prev => prev ? { ...prev, animals_image: url } : { id: 'default', hero_image: '', about_image: '', animals_image: url, updated_at: '' })} 
